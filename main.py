...
with tabs[1]:
    ...
    if not df.empty:
        ...
        if not trend.empty:
            ...
            # ===== Department-wise breakup BELOW the chart =====
            st.markdown("### 🏢 Department-wise Pending Breakdown")
            dept_counts = (
